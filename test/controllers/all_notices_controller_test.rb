...
class AllNoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create all_notice" do
    assert_difference('AllNotice.count') do
      post all_notices_url, params: { all_notice: { content: @all_notice.content, notice: @all_notice.notice, notice: @all_notice.notice, title: @all_notice.title, user_id: @all_notice.user_id } }
    end
  ...
  test "should update all_notice" do
    patch all_notice_url(@all_notice), params: { all_notice: { content: @all_notice.content, notice: @all_notice.notice, notice: @all_notice.notice, title: @all_notice.title, user_id: @all_notice.user_id } }
