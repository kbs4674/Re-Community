...
#명소가게 탐방
store1 = Bulletin.create( title: "우리가게 홍보", content: "사장님들이 직접 홍보하는 가게입니다.", user_id: "1", promote_store: "true", main_hidden: "true" ) #post id : 10
store2 = Bulletin.create( title: "가게 방문후기", content: "맛집탐방, 명소가게 후기", user_id: "1" ) #post id : 11

#구인구직
job_find1 = Bulletin.create( title: "일자리 : 구인", content: "일자리에 적합한 사람을 구하는 게시판", user_id: "1", search_job: "true" ) #post id : 12
job_find2 = Bulletin.create( title: "일자리 : 구직", content: "아르바이트 혹은 일자리 알아보는 게시판", user_id: "1", seeking_job: "true", main_hidden: "true" ) #post id : 13

#거래
room_sell = Bulletin.create( title: "복덕방", content: "방 정보 게시판", user_id: "1", info_room_trade: "true", main_hidden: "true" ) #post id : 14
room_find = Bulletin.create( title: "방 구해요", content: "학생들이 방을 구하는 게시판.", user_id: "1", seeking_room: "true", main_hidden: "true" ) #post id : 15
trade = Bulletin.create( title: "아나바다", content: "중고거래 게시판", user_id: "1", info_trade: "true" ) #post id : 16

#비공개 게시판
for_boss = Bulletin.create( title: "사장님 공지사항", content: "사장님들께 소식을 전해드리는 게시판.", user_id: "1",  main_hidden: "true", member_boss: "true" ) #post id : 17
for_boss = Bulletin.create( title: "학교 관계자 공지사항", content: "학교 관계자 분들께 소식을 전해드리는 게시판.", user_id: "1", main_hidden: "true", member_univ: "true" ) #post id : 18
