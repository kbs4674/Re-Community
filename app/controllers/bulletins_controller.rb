class BulletinsController < ApplicationController
  ...
  private
    ...
    def bulletin_params
      ...
      params.require(:bulletin).permit(:title, :content, :user_id, :info_part_time_job, :info_no_named, :info_room_trade, :info_trade, :promote_store, :vote, :seeking_room, :main_hidden, :member_boss, :member_univ, :member_real_estate, :admin_only, :group, :qna)
    end
end
